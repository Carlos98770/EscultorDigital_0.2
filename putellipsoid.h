...
/**
 * @brief A classe PutEllipsoid representa a criação de um elipsoide em um Sculptor.
 */
class PutEllipsoid : public FiguraGeometrica{
private:
    int xcenter,ycenter,zcenter; /// Coordenadas do centro do elipsoide no Sculptor.
...
public:
     ...
     * @param t Referência para um objeto Sculptor onde o elipsoide será desenhado.
     */
    void draw(Sculptor &t);
    /**
     * @brief Construtor parametrizado da classe PutEllipsoid.
     * @param v Vetor contendo as informações do elipsoide (xcenter, ycenter, zcenter, raiox, raioy, raioz, r, g, b, a).
     */
