...
/**
 * @brief A classe ReadOff é responsável por ler um arquivo e criar desenhos em um Sculptor.
 */
class ReadOff{
private:
    std::ifstream fin; /// Stream de entrada para ler o arquivo de instruções do desenho.
...
public:
     ...
     * @param desenho Vetor de ponteiros para FiguraGeometrica onde os desenhos serão armazenados.
