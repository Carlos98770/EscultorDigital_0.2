...
/**
 * @brief A classe CutEllipsoid representa a remoção de um elipsoide em um Sculptor.
 */
...
public:
     ...
     * @param v Vetor contendo as informações do elipsoide a ser removido (xcenter, ycenter, zcenter, raiox, raioy, raioz).
     */
