...
private:
    int xcenter,ycenter,zcenter; /// Coordenadas do centro da esfera no Sculptor.
...
public:
    ...
    */
     ...
     * @param v Vetor contendo as informações da esfera a ser removida (xcenter, ycenter, zcenter, radius).
     */
